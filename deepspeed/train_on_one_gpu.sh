...
--output_dir /ssdData/llm/deepspeed/models/t5-small --overwrite_output_dir --fp16 \
...
--output_dir /ssdData/llm/deepspeed/models/t5-large --overwrite_output_dir \
--do_train \
--do_eval \
...
python translation/run_translation.py \
    ...
    --output_dir /ssdData/llm/deepspeed/models/t5-small \
    --per_device_train_batch_size=4 \
    --per_device_eval_batch_size=4 \
